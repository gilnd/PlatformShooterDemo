...
draw_roundrect_ext(x, y, x+boxWidth, y+boxHeight, radius, radius, false);
/*
draw_set_color(c_white)
draw_roundrect_ext(x, y, x+boxWidth, y+boxHeight, radius, radius, true);
*/
...
draw_text_transformed(x+padding,y+padding, string(title)+": ", 1, 1, 0);
